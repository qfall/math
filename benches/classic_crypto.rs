...
/// These constants were previously generated by [`rsa_textbook::gen`]
...
#[allow(dead_code)]
/// Rejection sampling for primes using uniform probability
...
mod rsa_textbook {
    ...
    #[allow(dead_code)]
    /// Naively generates an RSA key pair with the provided `security_lvl`.
    ...
    /// where `msg` is sampled uniformly at random
    pub fn rsa_run() {
...
pub fn bench_rsa(c: &mut Criterion) {
    c.bench_function("RSA enc+dec", |b| b.iter(|| rsa_textbook::rsa_run()));
}
