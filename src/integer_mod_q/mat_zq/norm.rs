...
use super::MatZq;
use crate::{integer::Z, rational::Q, traits::GetNumColumns};
...
impl MatZq {
    ...
    /// use std::str::FromStr;
    ///
    /// let vec = MatZq::from_str("[[2, 3],[2, 0]] mod 7").unwrap();
    ///
    ...
    /// use std::str::FromStr;
    ///
    /// let vec = MatZq::from_str("[[2, 3],[2, 0],[3, 4],[3, 4]] mod 5").unwrap();
    ///
    ...
    /// use std::str::FromStr;
    ///
    /// let vec = MatZq::from_str("[[2, 4],[2, 0]] mod 7").unwrap();
    ///
