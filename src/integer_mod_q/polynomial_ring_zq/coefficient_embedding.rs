...
impl IntoCoefficientEmbedding<MatZq> for &PolynomialRingZq {
    ...
    /// };
    ///
    /// let poly = PolynomialRingZq::from_str("3  17 3 -5 mod 19").unwrap();
...
impl FromCoefficientEmbedding<&MatZq> for PolynomialRingZq {
    ...
    /// let poly = PolynomialRingZq::from_coefficient_embedding(&vector);
    /// let cmp_poly = PolynomialRingZq::from_str("3  17 3 -5 mod 19").unwrap();
