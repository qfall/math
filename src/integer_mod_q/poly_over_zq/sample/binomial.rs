...
impl PolyOverZq {
    ...
    pub fn sample_binomial(
        ...
        Self::sample_binomial_with_offset(max_degree, 0, modulus, n, p)
    }
...
mod test_sample_binomial {
    ...
    fn nr_coeffs() {
        ...
        for degree in degrees {
            let res = PolyOverZq::sample_binomial(degree, u64::MAX, 256, 0.99999).unwrap();
    ...
    fn invalid_max_degree() {
        let res_0 = PolyOverZq::sample_binomial(-1, 7, 2, 0.5);
        let res_1 = PolyOverZq::sample_binomial(i64::MIN, 7, 2, 0.5);
    ...
    #[test]
    fn availability() {
        let _ = PolyOverZq::sample_binomial(1, 7u8, 1u16, 7u8);
        let _ = PolyOverZq::sample_binomial(1, 7u16, 1u32, 7u16);
        let _ = PolyOverZq::sample_binomial(1, 7u32, 1u64, 7u32);
        let _ = PolyOverZq::sample_binomial(1, 7u64, 1i8, 7u64);
        let _ = PolyOverZq::sample_binomial(1, 7i8, 1i16, 7i8);
        let _ = PolyOverZq::sample_binomial(1, 7i16, 1i32, 7i16);
        let _ = PolyOverZq::sample_binomial(1, 7i32, 1i64, 7i32);
        let _ = PolyOverZq::sample_binomial(1, 7i64, Z::ONE, 7i64);
        let _ = PolyOverZq::sample_binomial(1, 7, 1u8, 0.5f32);
        let _ = PolyOverZq::sample_binomial(1, 7, 1u8, 0.5f64);
        let _ = PolyOverZq::sample_binomial(1, 7, 1, Q::from((1, 2)));
    }
}
...
mod test_sample_binomial_with_offset {
    ...
    fn nr_coeffs() {
        let degrees = [1, 3, 7, 15, 32, 120];
        for degree in degrees {
            let res = PolyOverZq::sample_binomial_with_offset(degree, 1, 7, 2, 0.5).unwrap();
    ...
    #[test]
    fn invalid_max_degree() {
        let res_0 = PolyOverZq::sample_binomial_with_offset(-1, -1, 7, 2, 0.5);
        let res_1 = PolyOverZq::sample_binomial_with_offset(i64::MIN, -1, 7, 2, 0.5);
    ...
    #[test]
    fn availability() {
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7u8, 1u16, 7u8);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7u16, 1u32, 7u16);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7u32, 1u64, 7u32);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7u64, 1i8, 7u64);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7i8, 1i16, 7i8);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7i16, 1i32, 7i16);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7i32, 1i64, 7i32);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7i64, Z::ONE, 7i64);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7, 1u8, 0.5f32);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7, 1u8, 0.5f64);
        let _ = PolyOverZq::sample_binomial_with_offset(1, 0, 7, 1, Q::from((1, 2)));
    }
}
