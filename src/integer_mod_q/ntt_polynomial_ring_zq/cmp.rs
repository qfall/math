...
use crate::{
    error::MathError,
    integer::{PolyOverZ, Z},
    integer_mod_q::{PolyOverZq, PolynomialRingZq, Zq},
    macros::compare_base::{
...
compare_base_default!(NTTPolynomialRingZq for PolyOverZ);
compare_base_get_mod!(NTTPolynomialRingZq for PolynomialRingZq NTTPolynomialRingZq);
compare_base_get_mod_get_q!(NTTPolynomialRingZq for Zq PolyOverZq);
