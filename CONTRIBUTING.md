# Contributing
This library is designed to prototype lattice-based cryptography. Our intent for this library is to be maintained by the community. We encourage anyone to add missing, frequently used features for lattice-based prototyping to this library and we are happy help with that process.
...
- We aim for multiple tests per function, its unforseen behavior, panic or error-cases to boost confidence in our implementations and ensure that modifications of a function only introduce intended changes of behavior.
...
Furthermore, here is an example for a doc-comment of a function that follows our guidelines.
```rust
impl Z {
